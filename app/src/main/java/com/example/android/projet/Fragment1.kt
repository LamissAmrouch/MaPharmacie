...
class Fragment1 : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        commencer.setOnClickListener { view ->
           ...
           /* var obj = SmsManager.getDefault() as SmsManager
            ...
            /* val TWILIO_ACCOUNT_SID2 = "AC5f10b34cac82dfe6a3a397bfaec4870c"
             val TWILIO_AUTO_TOKEN2 = "b041bae2f3649ced48d1f3104fd67c90"
             val MY_PHONE_NUMBER = "+213558757779"
             val client = TwilioRestClient.Builder(TWILIO_ACCOUNT_SID2,TWILIO_AUTO_TOKEN2).build()
